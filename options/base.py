...
class baseOpt:
	...
	def initialize(self, parser):
		...
		parser.add_argument('--lr1', type=float, default=5e-4, help='learning rate for the generator')
		parser.add_argument('--lr2', type=float, default=5e-6, help='learning rate for the discriminator')
		parser.add_argument('--beta1', type=float, default=0.5, help='beta1 hyp. for the Adam optimizer')
		parser.add_argument('--lambda_GAN', type=float, default=0.01, help='lambda for the Adversarial Loss')
