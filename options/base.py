...
class baseOpt:
	...
	def initialize(self, parser):
		...
		parser.add_argument('--lr1', type=float, default=2e-4, help='learning rate for the generator')
		...
		parser.add_argument('--Attention', type=bool, default=False, help='Attention mode')
