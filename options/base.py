...
class baseOpt:
	...
	def initialize(self, parser):
		...
		parser.add_argument('--out_act', type=str, default='tanh', help='final activation: sigmoid, tanh')
		...
		parser.add_argument('--attention_gen', type=str2bool, default=False, help='Attention mode')
